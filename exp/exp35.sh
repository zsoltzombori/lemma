...
# Target based on reproof. Each lemma is evaluated by removing it from the other lemmas in the proof

export EXPERIMENT=35
export PROBLEM_FILE="rated_problems.txt"
export PROVER_TIMEOUT=100
export PROVER_CONFIG="f_sgcd_basic"
export PROVECD_CONFIG="[lemma_methods=[subtree],lemmas_not_in_proof,reproof_mode=without_lemma,reproof_limit=[inf,5]]"
...
export DATAGEN_CONFIG="[timeout=[inf,5],processing=datagen,red=[subs,subt],head=10,lemma_methods=[subtree],lemmas_not_in_proof,reproof_mode=without_lemma]"
export DATAGEN=1
