...
# parent: 67
# LEMSORT_DEFAULT="[lf_h_height,lf_h_subterms_not_in_goal,lf_h_tsize,lf_h_distinct_vars,dcterm_hash]"
# LEMSORT_TRAIN: 1 -> 0


export EXPERIMENT=122
export PROBLEM_FILE="rated_problems.txt"
export PROVER_TIMEOUT="[inf,100]"
export SECURITY_TIMEOUT=1000
...
export DATAGEN=0
export LEMSORT_DEFAULT="[lf_h_height,lf_h_subterms_not_in_goal,lf_h_tsize,lf_h_distinct_vars,dcterm_hash]"
export LEMSORT_TRAIN=0
export EXPDIR="out/exp${EXPERIMENT}"
export PROVER_CORENUM=100
export LEMGEN_CORENUM=20
export CUDA_VISIBLE_DEVICES=4

bash iterative_debug.sh > log/exp${EXPERIMENT}.out 2> log/exp${EXPERIMENT}.err
