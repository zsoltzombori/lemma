...
# parent: 141
# trying to prove lcl073-1
# PROVER_CONFIG: f_sgcd_basic -> provecd_sgcd_ph_0321.pl
# LEMGEN_CONFIG: lg_tsize_optim.pl: lg_psp_optim_7.pl
# LEMMA_COUNT: 200 -> 3000


export EXPERIMENT=144
