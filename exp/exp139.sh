...
# parent: 138
# TRAIN_CONCAT_LINEAR: 0 -> 1



export EXPERIMENT=139
...
export TRAIN_CONCAT_LINEAR=1
export LEMMA_COUNT=200
export LEMMA_UTILITY="u_reproof"
export LEMMA_FORMAT="dterm"
export LEMGEN_CONFIG="lg_tsize_optim.pl"
export DATAGEN_CONFIG="[timeout=[inf,5],processing=datagen,red=[subs,subt],head=10,lemma_methods=[subtree],reproof_timeout=[inf,15]]"
export DATAGEN=1
