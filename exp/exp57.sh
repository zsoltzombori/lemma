...
# parent: 55
# trying to reproduce the performance of exp35
# no_reproof -> reproof_timeout=[inf,15],reproof_mode=without_lemma


export EXPERIMENT=57
export PROBLEM_FILE="rated_problems.txt"
export PROVER_TIMEOUT=100
export PROVER_CONFIG="f_sgcd_basic"
export PROVECD_CONFIG="[lemma_methods=[subtree],lemmas_not_in_proof,reproof_mode=without_lemma,reproof_timeout=[inf,15]]"
...
export DATAGEN_CONFIG="[timeout=[inf,5],processing=datagen,red=[subs,subt],head=10,lemma_methods=[subtree],lemmas_not_in_proof,reproof_mode=without_lemma,reproof_timeout=[inf,15]]"
export DATAGEN=1
