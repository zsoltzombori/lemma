...
# parent: 86
# PROVER_TIMEOUT: 100 -> 500
# SECURITY_TIMEOUT: 1000 -> 1500


export EXPERIMENT=110
export PROBLEM_FILE="rated_problems.txt"
export PROVER_TIMEOUT="500"
export SECURITY_TIMEOUT=1500
export PROVER_CONFIG="provecd_eprover_autoschedule.pl"
export PROVECD_CONFIG="[lemma_methods=[subtree]]"
...
export LEMSORT_TRAIN=2
export OLD_MODEL="/home/zombori/terms22/experiments/out/exp67/2/model"
