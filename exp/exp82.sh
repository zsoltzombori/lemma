...
# parent: 79
# problem_file: rated_problems.txt -> rated_problems_special.txt


export EXPERIMENT=82
export PROBLEM_FILE="rated_problems_special.txt"
export PROVER_TIMEOUT="[inf,100]"
export PROVER_CONFIG="f_sgcd_height"
