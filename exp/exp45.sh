...
# parent: 40
# PROVER_CONFIG: provecd_sgcd_s1.pl -> provecd_sgcd_s1_g.pl
# LEMGEN_CONFIG: lg_tsize_optim.pl -> lg_tsize_optim_g.pl
# LEMSORT_DEFAULT

export EXPERIMENT=45
export PROBLEM_FILE="rated_problems.txt"
export PROVER_TIMEOUT=20
export PROVER_CONFIG="provecd_sgcd_s1_g.pl"
...
export LEMGEN_CONFIG="lg_tsize_optim_g.pl"
