...
# Target based on reproof. Each lemma is evaluated by adding it alone to the axioms

export EXPERIMENT=28
export PROBLEM_FILE="rated_problems.txt"
export PROVER_TIMEOUT=100
export PROVER_CONFIG="f_sgcd_basic"
export PROVECD_CONFIG="[lemma_methods=[subtree],lemmas_not_in_proof]"
...
export DATAGEN_CONFIG="[timeout=[inf,5],processing=datagen,red=[subs,subt],head=10,lemma_methods=[subtree],lemmas_not_in_proof]"
export DATAGEN=1
