...
# parent: 49
# provecd gets -l "[max_lemmas=100,add_subproof_lemmas]"
# provecd reproof_timeout 15 -> 50


export EXPERIMENT=53
export PROBLEM_FILE="rated_problems.txt"
export PROVER_TIMEOUT=50
export PROVER_CONFIG="provecd_sgcd_s1.pl"
export PROVECD_CONFIG="[lemma_methods=[subtree],lemmas_not_in_proof,reproof_timeout=[inf,50]]"
...
export DATAGEN_CONFIG="[timeout=[inf,15],processing=datagen,red=[subs,subt],head=30,lemma_methods=[subtree],lemmas_not_in_proof,reproof_timeout=[inf,15]]"
export DATAGEN=1
