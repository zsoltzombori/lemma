...
# parent: 51
# trying to reproduce the performance of exp34
# PROVER_CONFIG: provecd_sgcd_s1.pl -> f_sgcd_basic
# PROVECD_CONFIG: [lemma_methods=[subtree],lemmas_not_in_proof,reproof_timeout=[inf,15]] -> [lemma_methods=[subtree],lemmas_not_in_proof,no_reproof]
# TRAIN_TOLERANCE: 10 -> 50
# DATAGEN_CONFIG: [timeout=[inf,15],processing=datagen,red=[subs,subt],head=30,lemma_methods=[subtree],lemmas_not_in_proof,reproof_timeout=[inf,15]] -> [timeout=[inf,5],processing=datagen,red=[subs,subt],head=10,lemma_methods=[subtree],lemmas_not_in_proof,no_reproof]


export EXPERIMENT=54
export PROBLEM_FILE="rated_problems.txt"
export PROVER_TIMEOUT=50
export PROVER_CONFIG="f_sgcd_basic"
export PROVECD_CONFIG="[lemma_methods=[subtree],lemmas_not_in_proof,no_reproof]"
